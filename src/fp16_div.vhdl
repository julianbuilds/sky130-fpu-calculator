...
entity FPDiv_5_10_F400_uid2 is
   port ( clk, rst : in std_logic;
...
architecture arch of FPDiv_5_10_F400_uid2 is
...
signal fY, fY_d1, fY_d2, fY_d3, fY_d4, fY_d5 :  std_logic_vector(12 downto 0);
signal fX :  std_logic_vector(13 downto 0);
signal w5, w5_d1 :  std_logic_vector(15 downto 0);
...
signal w3, w3_d1 :  std_logic_vector(15 downto 0);
...
signal w1, w1_d1 :  std_logic_vector(15 downto 0);
...
begin
   ...
   sel5 <= w5_d1(15 downto 11) & fY_d1(10 downto 9);
   ...
   w4fulla <= 
      w5pad - ("0000" & fY_d1)			when "01",
      w5pad + ("0000" & fY_d1)			when "11",
      w5pad + ("000" & fY_d1 & "0")	  when "10",
      w5pad 			   		  when others;
   ...
   sel4 <= w4_d1(15 downto 11) & fY_d2(10 downto 9);
   ...
   w3fulla <= 
      w4pad - ("0000" & fY_d2)			when "01",
      w4pad + ("0000" & fY_d2)			when "11",
      w4pad + ("000" & fY_d2 & "0")	  when "10",
      w4pad 			   		  when others;
   ...
   sel3 <= w3_d1(15 downto 11) & fY_d3(10 downto 9);
   ...
   w2fulla <= 
      w3pad - ("0000" & fY_d3)			when "01",
      w3pad + ("0000" & fY_d3)			when "11",
      w3pad + ("000" & fY_d3 & "0")	  when "10",
      w3pad 			   		  when others;
   ...
   sel2 <= w2_d1(15 downto 11) & fY_d4(10 downto 9);
   ...
   sel1 <= w1_d1(15 downto 11) & fY_d5(10 downto 9);
   ...
   expR1 <= expR0_d7 + ("000" & (3 downto 1 => '1') & fR(14)); -- add back bias
   ...
   R <= exnRfinal & sR_d8 & expfracR(14 downto 0);
end architecture;
